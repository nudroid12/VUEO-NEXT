...
class LibraryStore(
        ...
        val entries =
            if (stored.isNotEmpty()) {
                ...
                history()
                    ...
                    .distinctBy {
                        continueWatchingTitleKey(it.media)
                    }
                    .also {
                        writeContinueWatching(it)
                    }
            }
    ...
    fun clearContinueWatching() {
        writeContinueWatching(emptyList())
        writeDismissedContinueWatchingKeys(
            dismissedContinueWatchingKeys() +
                history()
                    .asSequence()
    ...
    private fun readContinueWatching():
        List<LibraryPlaybackEntry> =
        readObjectArray(
            scopedKey(
    ...
    companion object {
        ...
        private const val MAX_CONTINUE_WATCHING =
            50
    }
}
